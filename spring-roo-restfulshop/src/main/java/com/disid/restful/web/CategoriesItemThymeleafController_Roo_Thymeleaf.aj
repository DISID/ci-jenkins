...
privileged aspect CategoriesItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView CategoriesItemThymeleafController.update(@Valid @ModelAttribute Category category, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
