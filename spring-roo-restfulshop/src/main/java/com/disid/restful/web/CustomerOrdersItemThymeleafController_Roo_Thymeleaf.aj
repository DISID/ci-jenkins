...
privileged aspect CustomerOrdersItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView CustomerOrdersItemThymeleafController.update(@Valid @ModelAttribute CustomerOrder customerOrder, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
